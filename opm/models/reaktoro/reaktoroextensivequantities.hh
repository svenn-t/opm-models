...
* \file
*
* \copydoc Opm::ReaktoroExtensiveQuantities
*/
#ifndef EWOMS_REAKTORO_EXTENSIVE_QUANTITIES_HH
#define EWOMS_REAKTORO_EXTENSIVE_QUANTITIES_HH
 ...
 *
 * \brief Contains all data which is required to calculate all fluxes at a flux  integration point for the chemical
 * transport model using Reaktoro
 *
 * This means pressure and concentration gradients, phase densities at
 * the integration point, etc.
 */
template <class TypeTag>
class ReaktoroExtensiveQuantities
