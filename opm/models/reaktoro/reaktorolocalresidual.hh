...
* \file
*
* \copydoc Opm::ReaktoroLocalResidual
*/
#ifndef EWOMS_REAKTORO_LOCAL_RESIDUAL_HH
#define EWOMS_REAKTORO_LOCAL_RESIDUAL_HH
...
*
* \brief Element-wise calculation of the local residual for the chemical transport model using Reaktoro
*/
template <class TypeTag>
class ReaktoroLocalResidual : public GetPropType<TypeTag, Properties::DiscLocalResidual>
{
