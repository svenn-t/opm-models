...
*/
#ifndef EWOMS_REAKTORO_RATE_VECTOR_HH
#define EWOMS_REAKTORO_RATE_VECTOR_HH
...
public:
    ReaktoroRateVector() : ParentType()
    { Opm::Valgrind::SetUndefined(*this); }

    /*!
    * \copydoc ImmiscibleRateVector::ImmiscibleRateVector(Scalar)
    */
    ReaktoroRateVector(const Evaluation& value)
        : ParentType(value)
    {}
    ...
    */
    ReaktoroRateVector(const ReaktoroRateVector& value) : ParentType(value)
    {}
    ...
    */
    template <class RhsEval>
    ReaktoroRateVector& operator=(const RhsEval& value)
    {
    ...
    */
    ReaktoroRateVector& operator=(const ReaktoroRateVector& other)
    {
        for (unsigned i=0; i < this->size(); ++i)
            (*this)[i] = other[i];
        return *this;
