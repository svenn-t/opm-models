...
*/
#ifndef EWOMS_REAKTORO_BOUNDARY_RATE_VECTOR_HH
#define EWOMS_REAKTORO_BOUNDARY_RATE_VECTOR_HH
 ...
 * \ingroup PvsModel
 *
 * \brief Implements a rate vector on the boundary for the fully implicit multiphase chemical transport model using
 * Reaktoro
 */
template <class TypeTag>
class ReaktoroBoundaryRateVector : public GetPropType<TypeTag, Properties::RateVector>
{
...
public:
    ...
    */
    ReaktoroBoundaryRateVector(const Evaluation& value)
        : ParentType(value)
    {}
    ...
    */
    ReaktoroBoundaryRateVector(const ReaktoroBoundaryRateVector& value) = default;
    ReaktoroBoundaryRateVector& operator=(const ReaktoroBoundaryRateVector& value) = default;
