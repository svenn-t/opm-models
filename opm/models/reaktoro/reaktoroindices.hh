...
*
* \brief Declares the properties required for the multiphase chemical transport model using Reaktoro.
*/
#ifndef EWOMS_REAKTORO_INDICES_HH
#define EWOMS_REAKTORO_INDICES_HH
...
* \ingroup ReaktoroModel
*
* \brief The indices for the multi-phase chemical transport model using Reaktoro
*
* \tparam PVOffset The first index in a primary variable vector.
*/
template <class TypeTag, int PVOffset>
class ReaktoroIndices : public EnergyIndices<PVOffset + getPropValue<TypeTag, Properties::NumComponents>(),
...
public:
    ...
    // Index of the first mole fraction
    static const int x0Idx = PVOffset + 1;
